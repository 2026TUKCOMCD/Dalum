...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @Query(value = "SELECT p.id AS id, p.large_category AS largeCategory, p.style AS style, p.material_vector AS materialVector, p.dominant_colors AS dominantColors " +
            "FROM product p " +
